...
-- Auto-confirms email and assigns admin role to the given user,
-- but ONLY if no active admin exists yet (first-time setup).
-- SECURITY DEFINER so it can write to auth.users and user_roles.
