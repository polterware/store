...
describe("schema registry", () => {
  it("covers all 31 tables from the schema contract", () => {
    expect(schemaRegistry.SCHEMA_REGISTRY).toHaveLength(31);
    expect(new Set(schemaRegistry.SCHEMA_TABLE_NAMES).size).toBe(31);
  });
